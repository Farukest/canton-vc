 ...
 * full navigation to the issuer and back. `sessionStorage` is the
...
export function createDefaultStorage(): SdkStorage {
  if (typeof globalThis.sessionStorage !== 'undefined') {
    try {
      const probe = '__canton_vc_probe__';
...
const STATE_KEY_PREFIX = 'canton-vc.oauth.state.';
const VERIFIER_KEY_PREFIX = 'canton-vc.oauth.verifier.';
const NONCE_KEY_PREFIX = 'canton-vc.oauth.nonce.';
const REDIRECT_KEY_PREFIX = 'canton-vc.oauth.redirect.';
