...
- `crivacy_disclosure_blob` carried-claim support — the helper accepts both `canton_vc_credential_blob` (CIP #204 alignment) and `crivacy_disclosure_blob` (legacy alias) on the claims object for compatibility with both userinfo response variants.
